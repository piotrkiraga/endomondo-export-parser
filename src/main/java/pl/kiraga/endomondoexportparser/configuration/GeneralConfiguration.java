...
public class GeneralConfiguration implements WebMvcConfigurer {
    ...
    /**
     * Serves the photo report generated by {@code PhotoReportGenerator} straight off
     * disk, at the same relative paths it was written with, so the file stays equally
     * openable by double-clicking it later with the app not running.
     */
    @Override
