...
import pl.kiraga.endomondoexportparser.util.HaversineUtil;
...
public class OverpassClient {
    ...
    private NearbyFeature toFeature(JsonNode element, double lat, double lon) {
        ...
        return new NearbyFeature(name, kind, HaversineUtil.metersBetween(lat, lon, elementLat, elementLon));
    ...
    private String featureName(JsonNode tags) {
        ...
        return OsmNamesUtil.primary(name);
    }
