...
public class StravaTokenStoreTest {
    ...
    private static final StravaTokensDto TOKENS = new StravaTokensDto("access-1", "refresh-1", 1_800_000_000L);
    ...
    void laterSaveOverwritesTheEarlierOne(@TempDir Path dir) {
        StravaTokenStore store = new StravaTokenStore(dir.resolve("tokens.json"));
        store.save(TOKENS);
        StravaTokensDto replacement = new StravaTokensDto("access-2", "refresh-2", 1_900_000_000L);
