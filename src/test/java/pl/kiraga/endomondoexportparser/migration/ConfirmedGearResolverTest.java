...
public class ConfirmedGearResolverTest {
    ...
    private Rig rigFor(Path dir) {
        ...
        StravaDictionary dictionary = new StravaDictionary(stravaClient, cache, FIXED);
    ...
    void displayUsesTheCachedDictionaryNameWithoutAnyNetworkCall(@TempDir Path dir) {
        Rig rig = rigFor(dir);
        new StravaDictionaryCache(dir.resolve("dictionary.json")).save(new StravaDictionarySnapshot(
