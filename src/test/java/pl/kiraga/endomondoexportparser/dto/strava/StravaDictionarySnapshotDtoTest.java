...
public class StravaDictionarySnapshotDtoTest {

    private static StravaDictionarySnapshotDto withLocation(String city, String state, String country) {
        return new StravaDictionarySnapshotDto(1L, "Piotr", "Kiraga", null, city, state, country, Map.of(), "now");
    }
